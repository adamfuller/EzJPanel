...
public abstract class EzJPanel extends JPanel implements MouseListener, MouseMotionListener, KeyListener, ComponentListener{
     ...
     * <p>
     *  everything in this function will be executed at the end of paintComponent
     *  but before before repaint()
     * 
     ...
     * 
     * @param stopLooping - if {@code true} the JPanel will stop repainting at the end of paintComponent
     */
    ...
    /**
     * returns the value of the boolean to determine whether or not to redraw the graphics
     * 
